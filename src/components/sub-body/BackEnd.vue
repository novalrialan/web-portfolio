    ...
    <li>
      ...
      >
        <div class="block">
          ...
          <img src="/src/assets/images/png/laravel.png" width="28" height="28" alt="laravel" srcset="">
    ...
    <li>
      ...
      >
        <div class="block">
          ...
          <img src="/src/assets/images/png/spring-boot.png" width="28" height="28" alt="spring-boot" srcset="">
    ...
    <li>
      ...
      >
        <div class="block">
          ...
          <img src="/src/assets/images/png/laravel-lumen.png" width="28" height="28" alt="laravel-lumen" srcset="">
          <div class="w-full text-lg font-semibold">Lumen</div>
          <div class="w-full text-sm">
            ...
            easy to manage and develop complex applications. React uses Virtual
            DOM to improve performance by only updating the parts that change.
            JSX syntax makes it easier to combine HTML elements in JavaScript
            code, making development more intuitive.
          </div>
        </div>
        <div
