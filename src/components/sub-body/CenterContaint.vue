          ...
          >
            ...
            >
              ...
              >
                ...
                used to add interactivity and functionality to web pages. It is
                interpreted,
                <a href="#">read more...</a>
              </p>
            </div>
          ...
          >
            ...
            >
              <p
                class="opacity-0 text-white text-sm 2xl:text-lg group-hover:opacity-80 transform duration-500"
              >
                Kotlin is a modern open-source programming language developed by
                JetBrains for building applications. It is
